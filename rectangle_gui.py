...
def populate_main_window(frm_main):
    ...
    height = tk.Label(frm_main, text="Height:")
    ...
    dis_area = tk.Label(frm_main, width=4)
    ...
    height.grid(  row=1, column=0, padx=3, pady=3)
    ...
    dis_area.grid( row=0, column=3, padx=3, pady=3)
